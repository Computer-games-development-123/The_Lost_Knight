...
/// <summary>
/// Handles Yoji's STORE interactions (opening shop).
/// This is SEPARATE from dialogue.
/// Attach this to Yoji GameObject ALONGSIDE YojiDialogueHandler.
/// </summary>
public class YojiStoreHandler : MonoBehaviour
{
    ...
    private bool ShouldShowStorePrompt()
    {
        ...
        if (dialogueHandler != null)
        {
            ...
            {
                // First time talking
                if (!GM.HasTalkedTo("Yoji")) return false;
